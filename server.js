...
///رابط المقطع: https://discord.gg/X2H46apn8T
...
ولتقديم علي الرتب يرجه كتابي  **-تقديم**`
          )
          .setTimestamp();
        c.send({
          embed: embed
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@639061475876405258>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
** ${prefix}ccolors :  صناعة الالوان ** 
** ${prefix}giveaway : عمل جيف اوي **
...
**\`♕MØĞRÈM_ĞÀMÈ♕رابط صاحب البوت\` : <https://discord.gg/X2H46apn8T>**
`);
        })
        .then((e) => {
          message.react("✅");
  ...
  if (ra3d.content.startsWith(prefix + "ccolors")) {
    ...
    if (!ra3d.member.hasPermission("MANAGE_ROLES"))
      return ra3d.channel.send(
        "`**⚠️ | `[MANAGE_ROLES] `لا يوجد لديك صلاحية**"
      );
                                    ...
                                    .then((m) => {
                                      ...
                                      m.channel
                                        ...
                                        .then((m5) => {
                                          ...
                                          message.channel
                                            .send(
                                              message.member + ", **:timer:**"
                                            )
                                            .then((m) => {
                                              m.edit(
                                                message.member +
                                                  ", **لماذا يجب علينا ان نقبلك ؟ 🤔**"
                                              );
                                              m.channel
                                                .awaitMessages(
                                                  (m1) =>
                                                    m1.author == message.author,
                                                  {
                                                    maxMatches: 1,
                                                    time: 80 * 1000,
                                                  }
                                                    ...
                                                    setTimeout(() => {
                                                      let embed =
                                                        new Discord.RichEmbed()
                                                          ...
                                                          .addField(
                                                            "**`ما هي الرتبه التي تردها؟`**",
                                                            `${ask3}`
                                                          )
                                                          .addField(
                                                            "**`لماذا يجب علينا قبوله ؟`**",
                                                            `${ask4}`
                                                          )
                                                          .setFooter(
